...
${OBJECTDIR}/DualCameraAligner.o: DualCameraAligner.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DualCameraAligner.o DualCameraAligner.cpp

${OBJECTDIR}/DualCameraMerger.o: DualCameraMerger.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DualCameraMerger.o DualCameraMerger.cpp

${OBJECTDIR}/FastUndistort.o: FastUndistort.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FastUndistort.o FastUndistort.cpp
...
${OBJECTDIR}/PointsCollectorChess.o: PointsCollectorChess.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointsCollectorChess.o PointsCollectorChess.cpp

${OBJECTDIR}/PointsCollectorCircles.o: PointsCollectorCircles.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointsCollectorCircles.o PointsCollectorCircles.cpp

${OBJECTDIR}/SingleCalibration.o: SingleCalibration.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SingleCalibration.o SingleCalibration.cpp

${OBJECTDIR}/TwoCamerasCalibrator.o: TwoCamerasCalibrator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TwoCamerasCalibrator.o TwoCamerasCalibrator.cpp

${OBJECTDIR}/Undistort.o: Undistort.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Undistort.o Undistort.cpp
